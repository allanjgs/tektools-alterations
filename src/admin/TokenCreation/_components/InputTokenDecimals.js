...
const InputTokenDecimals = ({ onAddQuantity }) => {
  ...
  return (
    <div className='flex flex-col gap-y-1 gap-x-5 text-base font-thin'>
      <span className='px-3'>Amount of decimals for your token*</span>
      <div className='flex flex-row gap-x-5'>
        <div className='flex border rounded-lg bg-accent'>
          ...
          <Input type="text" value={quantity} onChange={handleChangeQuantity} placeholder="Exemple: 5 (means .00000)" className='text-center px-0 rounded-none border-none' />
...
export default InputTokenDecimals;