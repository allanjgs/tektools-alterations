        ...
        <tbody>
          {traits.map((trait, index) => (
            <tr key={index} className='bg-basic hover:bg-third border-second border-t'>
              <td className='px-3 py-2 border-r border-second'>{trait.type}</td>
              <td className='px-3 py-2 border-r border-second'>{trait.value}</td>
              <td className='px-3 py-2 border-r border-second'>{trait.role}</td>
